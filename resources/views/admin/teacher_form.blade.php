...
<div class="container-fluid">
    ...
    <form method="POST" action="{{ $teacher ? route('admin.teachers.update', $teacher) : route('admin.teachers.store') }}" class="card">
        @csrf
        ...
        <div class="card-body">
            ...
            <div class="row g-3">
                <div class="col-md-6">
                    ...
                    <input type="text" name="nip" class="form-control" value="{{ old('nip', $teacher?->user?->nip) }}" required>
                </div>
                ...
                <div class="col-md-12">
                    ...
                    <input type="text" name="nama_lengkap" class="form-control" value="{{ old('nama_lengkap', $teacher?->nama_lengkap) }}" required>
                </div>
                ...
                <div class="col-md-4">
                    ...
                    <input type="text" name="no_hp" class="form-control" value="{{ old('no_hp', $teacher?->no_hp) }}">
                </div>
            ...
            <div class="row g-3 mb-4">
                @foreach($sessions as $session)
                    <div class="col-md-6 col-lg-4">
                        <label class="ui-soft-panel d-block h-100" style="cursor:pointer;">
            ...
            <div class="row g-2 mb-4">
                @foreach($dayLabels as $value => $label)
                    <div class="col-6 col-md-3 col-lg">
                        <label class="ui-soft-panel d-flex align-items-center gap-2 justify-content-center" style="cursor:pointer;">
